...
>
  <i class="fa-solid fa-thumbs-up me-1"></i> BEST SELLER
    ...
    $html_product_fv .='<div class="col-12 col-sm-6 col-md-4 col-lg-3 mb-4">
  <div
    class="card position-relative h-100 radius_shadow_2"
    style="width: 100%; max-height: 450px; overflow: hidden;"
    data-aos="zoom-in"
  ...
  >
    <a href="'.$link.'" class="text-dark text-decoration-none">
      ...
      <div class="card-body">
        ...
        <p class="card-text ita">'.$short_description.'</p>
      </div>
    </a>
  </div>
</div>';
