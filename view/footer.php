...
<section
      ...
      class="myfooter bg-dark text-white py-3"
    >
      <div class="container">
        <!-- Row 1: Gồm 4 col -->
        <div class="row">
        ...
        <div class="row">
          ...
          <div class="col-12 col-sm-6 col-md-6 mt-5">
            <div class="row mb-4">
              <h5>T+ COFFEE</h5>
              <p>
                Copyright@ 2025 Công ty cổ phần thương mại T COFFEE Chứng nhận
                ĐKKD số: 0388282938 do sở KH & ĐT TP.HCM cấp <br />Địa chỉ: Tòa
                nhà 123 Đường 3 tháng 2, TP.HCM<br />
                Điện thoại: 190099999 - Email: tcoffee@gmail.com
              </p>
            </div>
            <div class="row">
